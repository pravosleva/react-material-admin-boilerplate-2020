...
export default class ImageGallery extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    const { items, lazyLoad, slideDuration, startIndex, thumbnailPosition, showThumbnails } = this.props
      ...
      <div>
        {item.imageSet ? (
          <picture onLoad={(event) => this.handleImageLoaded(event, item)} onError={handleImageError}>
            ...
            <img className="image-gallery-image" alt={item.originalAlt} src={itemSrc} />
          </picture>
        ) : (
          <img
